configuration BaseConfig
{
    ...
    Registry ConfigurationVersion
    {
        Key = "HKLM:\SOFTWARE\DSC\$currentConfigName"
        ValueName = 'ConfigurationVersion'
        ValueData = $ExecutionContext.SessionState.Module.Version
        Ensure = 'Present'
        ValueType = 'String'
    }
